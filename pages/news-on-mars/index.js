                        ...
                        return (
                            <article className="sm:grid md:flex sm:flex-col md:flex-row max-w-full  mt-6 mb-8 shadow-lg rounded-lg overflow-hidden"
                                ...
                                <div className="sm:w-full md:w-2/3 px-4  py-6 ">
                                    ...
                                    ><a href={`/news-on-mars/news${results.link[index].substring(26).trim()}`} className="px-3  py-2 bg-gray-800 text-white text-xs font-bold uppercase rounded">Find out more</a></Link>
                                </div>
                            </article>
                        )
                    })}
